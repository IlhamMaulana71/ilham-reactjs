...
import CardFuntionComponents from './CardFuntionComponents';

function NewsApiFuntionComponents(){
    ...
    return(
        ...
        <nav className="navbar navbar-expand-lg bg-black ">
            ...
            <div className="flex gap-3 md:order-2">
                <h1 className="text-primary">Funtion Components New App</h1>
            </div>
          ...
          <div className="row text-center">
            {news.filter((data) => 
              data.title.toLowerCase().includes(search)
                ...
                return(
                  <CardFuntionComponents data={data}/>
                )
              })
            }
          </div>
...
export default NewsApiFuntionComponents;